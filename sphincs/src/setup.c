...
#define __pyx_kp_u_py __pyx_string_tab[3]
#define __pyx_n_u_Cython_Build __pyx_string_tab[4]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[5]
#define __pyx_n_u_compiler_directives __pyx_string_tab[6]
#define __pyx_n_u_cythonize __pyx_string_tab[7]
#define __pyx_n_u_ext_modules __pyx_string_tab[8]
#define __pyx_n_u_language_level __pyx_string_tab[9]
...
#define __pyx_n_u_setup __pyx_string_tab[15]
#define __pyx_n_u_setuptools __pyx_string_tab[16]
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_setuptools, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_Cython_Build, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  __pyx_t_4 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_setup); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 5, __pyx_L1_error)
...
*/
  __pyx_t_7 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_cythonize); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_9 = __Pyx_PyList_Pack(1, __pyx_mstate_global->__pyx_kp_u_py); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_10 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  if (PyDict_SetItem(__pyx_t_10, __pyx_mstate_global->__pyx_n_u_language_level, __pyx_mstate_global->__pyx_kp_u_3) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_t_11 = 1;
  {
    ...
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_compiler_directives, __pyx_t_10, __pyx_t_12, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
    __pyx_t_6 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_8, __pyx_callargs+__pyx_t_11, (2-__pyx_t_11) | (__pyx_t_11*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_12);
  ...
  __pyx_t_11 = 1;
  {
    ...
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_ext_modules, __pyx_t_6, __pyx_t_8, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
    __pyx_t_2 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_5, __pyx_callargs+__pyx_t_11, (1-__pyx_t_11) | (__pyx_t_11*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_8);
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{1},{4},{12},{18},{19},{9},{11},{14},{8},{10},{8},{12},{10},{5},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (123 bytes) */
const char* const cstring = "x\332%\214K\016\0021\014C\357\303\242\033\016\200\004\007\211Bj\206\210\364C\233\216\030NO\231\361\302~\222e\207\363\345\024\352v\333\374Yr\270\016\265(\246\031\244\231\274\261\340\316\362\222\222\252\032\032Em\020\327\025]\366\201~\201\217S*q\030\272q^\006/ \303\n#J<O\246\216\372O\231\323\236\357\301vp\207G<x\230O\032u7/\305:\221\243;\321\017\034\241@\362";
    ...
    #endif
    #else /* compression: none (161 bytes) */
const char* const bytes = ".3?*.pyCython.Buildcline_in_tracebackcompiler_directivescythonizeext_moduleslanguage_level__main____module____name____qualname__setdefaultsetupsetuptools__test__";
    PyObject *data = NULL;
